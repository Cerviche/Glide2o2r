...
## 🎯 Key Features
* ⚡ **Three-stage pipeline:** Hash once, map many times, convert repeatedly.
* 🚀 **GPU-accelerated mapping (optional):** Reduces processing time from hours to seconds.
* 🔁 **Duplicate-aware:** Correctly handles textures reused across many assets.
* 🎚️ **Quality-based matching:** Weighted distance + confidence scoring.
* 🎭 **Alpha-aware matching:** Transparency is treated correctly to avoid visual glitches.
* 🔒 **Safe by design:** Original texture packs are never modified.
* 📝 **Rich reporting:** Generates CSV + JSON outputs with detailed statistics.
* 🔁 **Fast experimentation:** Cached hashes make remapping instant.

---

## 📁 Texture Formats Explained

### 🧩 Rice / Glide Format (Legacy)
...
├── map.py                      # Step 2: Mapping generator (CPU/GPU)
├── convert.py                  # Step 3: Texture converter
├── glide_hashes_*.json         # Generated by hash.py
├── soh_hashes_*.json           # Generated by hash.py
...
## 📊 Understanding Distance and Confidence
...
| **1–2** | **Very high confidence** (recommended default) |
| **3–4** | **Acceptable**, but risk of false positives increases |
...
* **Mapping (CPU):** 2–6 hours
* **Mapping (GPU):** Seconds
* **Conversion:** Minutes
* **Match rate:** 40–60% depending on pack
